...
public class RunExperimentDKproTC
{
    ...
    public static final String[] inputFilesTrain = new String[] {
        "src/main/resources/train/STS.input.MSRpar.txt",
        "src/main/resources/train/STS.input.MSRvid.txt",
        "src/main/resources/train/STS.input.SMTeuroparl.txt"
    };
    
    public static final String[] goldFilesTrain = new String[] {
        "src/main/resources/train/STS.gs.MSRpar.txt",
        "src/main/resources/train/STS.gs.MSRvid.txt",
        "src/main/resources/train/STS.gs.SMTeuroparl.txt"
    };
