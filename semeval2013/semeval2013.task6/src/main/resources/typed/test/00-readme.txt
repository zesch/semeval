...
The test dataset for the TYPED-SIMILARITY PILOT contains the following:
...
The script will produce the following directories and files:
...
Please follow these instructions if you want to make sure you will be 
able to retrieve the data for the train and test datasets.
...
Now you can run visualizer.pl and get HTML files to visualize the pairs:
...
The gold standard in the test data has been assembled using
crowdsourcing, gathering several scores per sentence pair. The gold
standard scores are the average of those scores.
...
For instance (actual numbers will differ):
