...
import semeval2013.task7.baseline.RandomAssessmentBaseline;
import semeval2013.task7.io.SemEval2013Task7Evaluator;
import de.tudarmstadt.ukp.dkpro.lab.engine.TaskContext;
import de.tudarmstadt.ukp.dkpro.lab.storage.StorageService.AccessMode;

public class RandomBaselineTask
    extends SemEval2013TaskBase
{

    private TaskFormat taskFormat;
    
    public RandomBaselineTask(TaskFormat taskFormat)
    {
        ...
        throws ResourceInitializationException, IOException
    {
        ...
        return createEngineDescription(
                createEngineDescription(
                        RandomAssessmentBaseline.class,
                        RandomAssessmentBaseline.PARAM_TASK_FORMAT, taskFormat
                ),
                createEngineDescription(
