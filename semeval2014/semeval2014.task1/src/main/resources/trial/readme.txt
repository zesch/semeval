...
The current release is a subset of the data set representing Task 1 Trial data (500 sentence pairs)
...
- semantic relatedness gold label (on a 1-5 continous scale)
